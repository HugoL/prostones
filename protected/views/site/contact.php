...
<div class="span12">
	...
	<div class="span6" id="espacioformulario">
			...
			<div class="span12 form_contacto">
				...
				<div class="span12 ">
					...
					<div class="row" id="reformas_colocaciones" >
						...
						<div class="tituloform textodiez">¿DÓNDE?</div>
					...
					<div class="row" id="incidencia_sugerencia" style="display:none">
						...
						<div class="tituloform textodiez">¿SOBRE QUÉ?</div>
					...
					<div class="tituloform textodiez">DIGANOS DE QUE SE TRATA *</div>
				...
				<div class="span8">
					...
					<div class=" span12 lineaform" >
						<div class="span12">
						<div class="tituloform textodiez">DIRECCIÓN</div>
					...
					<div class=" span12 lineaform">
						<div class="span4">
						<div class="tituloform textodiez">CÓDIGO POSTAL</div>
						...
						<div class="span4">
						<div class="tituloform textodiez">LOCALIDAD</div>
						...
						<div class="span4">
						<div class="tituloform textodiez">PROVINCIA</div>
					...
					<div class="span12 lineaform">
						<div class="span6">
						<div class="tituloform textodiez">E-MAIL *</div>
						<?php //echo $form->labelEx($model,'email'); ?>
						<?php echo $form->textField($model,'email',array('size'=>8,'maxlength'=>255)); ?>
						<?php echo $form->error($model,'email'); ?>
						</div>
						<div class="span6">
						<div class="tituloform textodiez">TELÉFONO</div>
					...
					<div class="tituloform textodiez">CÓDIGO DE VERIFICACIÓN</div>
	...
	<div class="span3" id="fototelefono">
		<img  alt="Catálogo de materiales - proSton.es"  src="<?php echo Yii::app()->request->baseUrl.Yii::app()->params['images'] ?>contactotelefono.png">
	</div>
</div>
