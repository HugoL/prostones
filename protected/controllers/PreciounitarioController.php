...
class PreciounitarioController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Preciounitario'];
			if($model->save())
	...
	{
		$model=new Preciounitario('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Preciounitario']))
			$model->attributes=$_GET['Preciounitario'];
...
$criteria4=new CDbCriteria; 
	 ...
	 * @return Preciounitario the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Preciounitario::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Preciounitario $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='preciounitario-form')
		{
