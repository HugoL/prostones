...
/**
 * This is the model class for table "ehp_terminaciones".
 *
 * The followings are the available columns in table 'ehp_terminaciones':
 * @property integer $id
 ...
 */
class Terminacion extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'valorpieza' => array(self::HAS_MANY, 'Valorpieza', 'id_terminacion'),
		);
	}
	 ...
	 * @return Terminacion the static model class
	 */
	...
	private static function loadItems($tipo)
	{
	 ...
	 foreach($models as $model)
 	 self::$_items[$tipo][$model->id]=$model->nombre . $model->tipo ;
	}
}
