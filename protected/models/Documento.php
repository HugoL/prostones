 ...
 * @property integer $id
 * @property integer $id_tipos_documento
 ...
 * @property TiposDocumentos $idTiposDocumento
...
class Documento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_tipos_documento, referencia, id_user, fecha, observaciones', 'required'),
			array('id_tipos_documento, referencia, id_user', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_tipos_documento, referencia, id_user, fecha, observaciones', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idTiposDocumento' => array(self::BELONGS_TO, 'TiposDocumentos', 'id_tipos_documento'),
			'idUser' => array(self::BELONGS_TO, 'Users', 'id_user'),
			'pedidoses' => array(self::HAS_MANY, 'Pedidos', 'id_documento'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'id_tipos_documento' => 'Id Tipos Documento',
	...
	public function search()
	{
		...
		$criteria->compare('id_tipos_documento',$this->id_tipos_documento);
	...
	private static function loadItems($tipo)
	{
	 ...
	 foreach($models as $model)
 	 self::$_items[$tipo][$model->id]=$model->referencia;
	}
}
